    ...
    <div class="bg-white p-4 rounded-lg shadow">
        ...
        <table class="table-auto w-full">
            ...
            <tr>
                ...
                <TableHeaderCell @click="" class="border-b-2 p-2 text-left" field="" sort-field="sortField"
...
import {PencilIcon, TrashIcon, EllipsisVerticalIcon} from "@heroicons/vue/20/solid/index.js";
