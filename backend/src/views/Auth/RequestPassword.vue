<template>
    <GuestLayout title="Request for a new password">
        <form class="mt-8 space-y-6" action="#" method="POST">
            ...
            <div class="flex items-center justify-between">
                <div class="text-sm">
                    <RouterLink to="/login" class="font-medium text-indigo-600 hover:text-indigo-500">Remember your password?</RouterLink>
                </div>
            </div>
